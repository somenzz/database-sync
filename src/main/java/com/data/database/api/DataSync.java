...
public interface DataSync {
    ...
    * @param targetDBIdentifier : 配置文件中目标数据库的标识符
    * @version 1.2
    */
    public String getDDL(String targetDBIdentifier ,String schemaName,String tableName,ColSizeTimes lenSize) throws SQLException;
